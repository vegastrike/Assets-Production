...
void main()
{
  ...
  //The essence of flat shading...
  //vec3 vnormal=iNormal; Instead of this, we do what we do next...
  ...
  //float den = clamp( r+vr, 0.0, 2.0 ) + 0.01; //denominator is very small at grazing angles, up to 2 face-on
  //float rel = clamp( 2.0 * r / den, 0.0, 2.0 ); //numerator
