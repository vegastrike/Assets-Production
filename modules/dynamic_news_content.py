...
{"siege" :	{"start"	:{"success":	{"good"		: []
		...
		,"end"		:{"success":	{"good"		: [(0.8,"all","In yet another event in the VAR_aggressor_posessive-VAR_defender_posessive war, VAR_aggressor_posessive forces have experienced a moral boosting victory today in the VAR_system_system system.  The blockade in the VAR_defender_posessive system ended today, three weeks after it began, with all VAR_defender_posessive supplies exhausted.  No information on the state of the infrastructure, or of casualties is as of yet available.")
								  ]
				 ...
				 ,"loss"   :	{"good"		: [(0.8,"all","loss is good")]
						...
						,"neutral"	: [(0.8,"all","loss is neutral")]
