module testd_relaunch_orderlist1 {
  import visit_aera;
  ...
  void launchAttackers(){
    ...
    launch.launch_waves_around_area("alpha","aera","aeon","_ai_stationary",8,2,500.0,1000.0,red_pos);
    launch.launch_waves_around_area("omega","aera","aevant","_ai_stationary",8,2,500.0,1000.0,green_pos);
