...
def MakePlanet (time_of_day='_day'):
    ...
    Base.Comp (room1, 'Computer', -0.6, -0.8, .2578906, 0.80833, 'Computer', 'BUYMODE SELLMODE UPGRADEMODE DOWNGRADEMODE INFOMODE SHIPMODE NEWSMODE MISSIONMODE BRIEFINGMODE')
