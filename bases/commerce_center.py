...
Base.Comp (room1, 'missioncomp', 0.2775, -0.28, 0.7175, 0.503333, 'Mission Computer', 'MISSIONMODE BRIEFINGMODE NEWSMODE')
...
Base.Comp (room2, 'buysell', -0.0625, -0.62, 0.7575, 0.3, 'Cargo Computer', 'BUYMODE SELLMODE')
