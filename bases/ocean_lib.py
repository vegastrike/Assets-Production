...
def MakeLandingAndConcourse (time_of_day='_day'):
    ...
    Base.Comp (room2, 'CargoComputer', -0.306641, -0.263021, 0.105469, 0.420833, 'Cargo Computer', 'Cargo')
    Base.Texture (room2, 'tex', 'bases/ocean/concourse'+new_time_of_day+'.spr', 0, 0)
    bar = bar_lib.MakeBar (room2,time_of_day)
    Base.Comp (room2, 'MissionComputer', 0.292969, -0.263021, 0.0878906, 0.420833, 'Mission Computer', 'News Missions')
