...
Base.Texture (bar,'bartender','bases/generic/bartender%d.spr' % (random.randrange(0,2)), -0.469922, 0.080208)
Base.Python (bar, 'talk', -0.669922, -0.119792, 0.4, 0.4, 'Talk to the Bartender', 'bases/bartender.py')
