...
def MakeCorisc(time_of_day='day'):
    ...
    Base.Python (bar, 'talk', 0.46875, -0.151042, 0.4, 0.4, 'Talk to the Bartender', 'bases/bartender_union.py')
    Base.Texture(bar,'bartender','bases/industrial/bartender%d.spr' % (random.randrange(0,2)),0.66875, 0.048958)
    ...
    if (time_of_day=='_day'):
        ...
        Base.Launch (room1, 'launch', -0.369844, -0.997396, 0.638672, 0.40625, 'Launch Your Ship')
    else:
        ...
        Base.Launch (room1, 'launch', -0.492188, -1, 0.982422, 0.625, 'Launch Your Ship')
