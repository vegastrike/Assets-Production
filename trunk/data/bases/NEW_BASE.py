...
Base.Comp (room, 'missioncomp', 0.2775, -0.28, 0.7175, 0.503333, 'Mission Computer', 'MissionMode BriefingMode NewsMode ')
...
Base.Comp (room, 'buysell', -0.0625, -0.62, 0.7575, 0.3, 'Cargo Computer', 'BuyMode SellMode ')
...
Base.Comp (room, 'upg', -0.3625, -0.726667, 0.2925, 1.72, 'Upgrade Ship', 'UpgradeMode DowngradeMode ')
Base.Comp (room, 'shd', 0.06, -0.68, 0.345, 0.74, 'Ship Dealer', ')
